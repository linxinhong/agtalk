...
// V13：node_runs 记录节点结果文本（input_summaries 上游摘要来源）。
const MIGRATE_V13: &str = r#"
ALTER TABLE node_runs ADD COLUMN result TEXT DEFAULT NULL;
"#;
